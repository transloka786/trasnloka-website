...
const COMPANY=[['/about','Our story'],['/india','India-first'],['/team','Our team'],['/how-we-work','How we work'],['/impact','Impact'],['/updates','Updates']];
