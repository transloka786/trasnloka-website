...
const COMPANY = [['/about','About'],['/team','Team'],['/partners','Partners'],['/community','Communities'],['/investors','Investors'],['/updates','Updates'],['/careers','Careers']];
