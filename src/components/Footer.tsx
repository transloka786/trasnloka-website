...
const EXPLORE = [['/problem','Problem'],['/science','Science'],['/platform','Platform'],['/small-world','Small-world engine'],['/pipeline','Programs'],['/india','India'],['/impact','Impact'],['/evidence','Evidence hub'],['/ask','Ask KritRNA']];
...
const LEARN = [['/rna-research-india','RNA research in India'],['/resources','Public resources'],['/explorer','Disease explorer'],['/glossary','Glossary'],['/references','References'],['/faq','FAQ'],['/search','Search']];

export default function Footer() {
  return <footer className="footer"><div className="wrap"><div className="foot-grid">
    <div><div className="foot-brand"><Image src="/logo.png" alt="" width={30} height={36}/> Krit<span style={{color:'var(--cyan)'}}>RNA</span></div><p>Developing suppressor-tRNA therapeutics through an India-first, evidence-led research platform.</p></div>
