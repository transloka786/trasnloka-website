...
export const PROGRAMS = [
  { name: 'β-Thalassemia', gene: 'HBB', area: 'Hematology · India-priority', goal: 'Design suppressor-tRNA candidates for selected HBB nonsense-mutation contexts.', stage: 'Program definition', next: 'Candidate design and in-vitro assay specification', accent: 'var(--cyan)' },
  { name: 'Duchenne muscular dystrophy', gene: 'DMD', area: 'Neuromuscular', goal: 'Design suppressor-tRNA candidates for selected DMD premature-stop contexts.', stage: 'Program definition', next: 'Candidate design and reporter-assay specification', accent: 'var(--magenta)' },
  { name: 'Cystic fibrosis', gene: 'CFTR', area: 'Pulmonary / epithelial', goal: 'Design suppressor-tRNA candidates for selected CFTR nonsense variants.', stage: 'Program definition', next: 'Candidate design and functional-assay planning', accent: 'var(--violet)' },
];
...
export const FAQ = [
  { q: 'What is KritRNA?', a: 'KritRNA is a research-stage, AI-guided suppressor-tRNA platform being developed by Transloka Bio Pvt. Ltd. Every candidate requires experimental validation.' },
  ...
  { q: 'How does a suppressor tRNA work?', a: 'A suppressor tRNA is designed to recognise a selected stop codon and deliver an amino acid during translation. Activity, identity, normal-stop effects, delivery and safety must be tested for every design.' },
  { q: 'Which diseases is KritRNA initially focusing on?', a: 'The initial research focus is selected nonsense variants in HBB, DMD and CFTR. These are research programs, not available treatments.' },
  ...
  { q: 'Is KritRNA’s technology clinically proven?', a: 'No. Nothing on this website is evidence of clinical efficacy, regulatory approval or an available therapy.' },
