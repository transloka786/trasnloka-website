...
const AUDIENCES = [
  ['Patients & families', 'Understand the science in plain language. KritRNA is research-stage and does not currently offer a treatment or trial.', '/resources', 'Start with the public guide'],
  ...
  return (
    <>
      ...
      <section className="ink-sec" style={{ borderTop: 'none' }}><div className="wrap">
        <Reveal><div className="sec-head"><div className="eyebrow">The disease, simply</div><h2 className="h2">The cell reaches “stop” too early</h2></div></Reveal>
      ...
      <section><div className="wrap">
        <Reveal><div className="sec-head"><div className="eyebrow">Choose your pathway</div><h2 className="h2">One website, four different questions</h2><p>The public, scientists, investors and potential team members need different levels of detail. Start with the path relevant to you.</p></div></Reveal>
      ...
      <section className="ink-sec"><div className="wrap split-2" style={{ display: 'grid', gap: 46, alignItems: 'center' }}>
        <Reveal><div><div className="eyebrow">India-first proposition</div><h2 className="h2" style={{ marginTop: 14 }}>Built in India. Designed for global science.</h2><p className="lead" style={{ marginTop: 20 }}>KritRNA is being developed in Noida as an India-first biotechnology platform: locally owned scientific capability, India-relevant research priorities and a validation network built through formal laboratories, CROs, clinicians and disease communities.</p><div style={{ marginTop: 25 }}><Link className="btn btn-ghost" href="/india" style={{ borderColor: 'var(--cream)', color: 'var(--cream)' }}>See the India-first strategy →</Link></div></div></Reveal>
      ...
      <section className="ink-sec center"><div className="wrap">
        <Reveal><div className="eyebrow" style={{ justifyContent: 'center' }}>Act from your role</div></Reveal><Reveal delay={0.04}><h2 className="h1" style={{ margin: '18px auto 0', maxWidth: '20ch' }}>Every message deserves to be <em style={{ color: '#ff6f9c' }}>read to completion.</em></h2></Reveal>
        <Reveal delay={0.08}><div style={{ marginTop: 32, display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}><Link className="btn btn-solid" href="/partners" style={{ background: 'var(--cream)', color: 'var(--ink)', borderColor: 'var(--cream)' }}>Scientific or CRO collaboration</Link><Link className="btn btn-ghost" href="/investors" style={{ borderColor: 'var(--cream)', color: 'var(--cream)' }}>Investor discussion</Link><Link className="btn btn-ghost" href="/careers" style={{ borderColor: 'var(--cream)', color: 'var(--cream)' }}>Join the team</Link></div></Reveal>
      </div></section>
    </>
  );
}
