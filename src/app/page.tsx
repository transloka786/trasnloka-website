  ...
  return (
    <>
      ...
      <section className="ink-sec center"><div className="wrap">
        <Reveal><div className="eyebrow" style={{ justifyContent: 'center' }}>The meaning of KritRNA</div></Reveal><Reveal delay={0.04}><h2 className="h1" style={{ margin: '18px auto 0', maxWidth: '20ch' }}><em style={{ color: '#ff6f9c' }}>Created with purpose.</em><br />Engineered to <em style={{ color: '#6bdcff' }}>continue.</em></h2></Reveal><Reveal delay={0.08}><p className="lead" style={{ margin: '22px auto 0', color: 'rgba(244,234,213,.72)' }}>KritRNA draws its name from कृ (<em>kṛ</em>), the Sanskrit root meaning “to make, create or act,” and tRNA—the molecular adaptor that helps translate genetic information into protein. Together, the name means tRNA created with purpose: engineered to recognise selected premature stop codons and help translation continue toward a full-length protein.</p></Reveal>
